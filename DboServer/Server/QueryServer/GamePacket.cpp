...
void CGameServerSession::RecvItemMoveStackReq(CNtlPacket* pPacket, CQueryServer* app)
{
	...
	// UNSTACK: crear �tem nuevo copiando TODO el estado v�a CreateItem (evita columnas faltantes)
	if (req->hDstItem == INVALID_HOBJECT)
	{
		...
		// 2) construir copia para el nuevo �tem con place/pos/count de destino
		...
		dst.charId = req->charId; // due�o actual
