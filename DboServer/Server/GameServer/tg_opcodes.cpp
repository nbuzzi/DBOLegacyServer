...
void CTG_Opcodes::BuildOpcodeList()
{
	...
	// Arena
	StoreOpcode(TG_ARENA_TELEPORT_INFO_REQ, "TG_ARENA_TELEPORT_INFO_REQ", PROCESS_THREADUNSAFE, &CChatServerSession::RecvArenaTeleportInfoReq);
	StoreOpcode(TG_ARENA_TELEPORT_INFO_RES, "TG_ARENA_TELEPORT_INFO_RES", PROCESS_THREADUNSAFE, &CChatServerSession::RecvArenaTeleportInfoRes);
}
