...
const char * s_packetName_TG[] =
{
	...
	DECLARE_PACKET_NAME( TG_RANKBATTLE_REMAIN_COUNT_FLUSH_NFY ),
	DECLARE_PACKET_NAME( TG_DAILY_LIMIT_COUNT_RESET_NFY ),
	DECLARE_PACKET_NAME( TG_MAIL_RECV_SERVER_NFY ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_SELL_RES ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_SELL_CANCEL_RES ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_PRICE_INFO_RES ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_BUY_RES ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_LIST_DATA ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_LIST_RES ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_PERIODEND_RES ),
	DECLARE_PACKET_NAME( TG_TENKAICHIDAISIJYOU_PERIODEND_TEXT ),
	DECLARE_PACKET_NAME( TG_WAGUCOIN_DECREASE_NFY ),
	DECLARE_PACKET_NAME( TG_EVENTCOIN_DECREASE_NFY ),
	DECLARE_PACKET_NAME( TG_WAGUWAGUMACHINE_UPDATE_CASHITEM_INFO ),

	// Arena
	DECLARE_PACKET_NAME( TG_ARENA_TELEPORT_INFO_REQ ),
	DECLARE_PACKET_NAME( TG_ARENA_TELEPORT_INFO_RES ),
