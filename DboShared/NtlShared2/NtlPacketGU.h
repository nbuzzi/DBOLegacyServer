...
BYTE			byItemPos;			// ���׷��̵� �� �������� ��ġ
BYTE			byItemGrade;
BYTE			byStonePlace;		// ȣ�����̽��� �����̳� ��ġ
BYTE			byStonePos;			// ȣ�����̽��� ��ġ
BYTE			byStoneStack;			// ���׷��̵� â�� ������ġ: (�������� ���Թ�ȣ * 10 + ȣ�����̽��潽�Թ�ȣ) 
BYTE			byCorePlace;
BYTE			byCorePos;
BYTE			byCoreStack;
END_PROTOCOL()
...
END_PROTOCOL()
//------------------------------------------------------------------
BEGIN_PROTOCOL(GU_VIRTUAL_TRANSFORM_DATA)
	HOBJECT			handle;
	DWORD			virtualTransformId;
	BYTE			targetRace;
	BYTE			targetGender;
	BYTE			targetFace;
	BYTE			targetHair;
	BYTE			targetHairColor;
	BYTE			targetSkinColor;
END_PROTOCOL()
//------------------------------------------------------------------
