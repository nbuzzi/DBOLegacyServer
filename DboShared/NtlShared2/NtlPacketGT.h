...
enum eOPCODE_GT
{
	...
	GT_BUDOKAI_MINOR_MATCH_INDIVIDUAL_LIST_NFY,			// ������ ���� ����Ʈ(õ�����Ϲ���ȸ ���� -> �Ϲ� ���Ӽ���)
	GT_BUDOKAI_MINOR_MATCH_TEAM_LIST_NFY,				// ������ ���� ����Ʈ(õ�����Ϲ���ȸ ���� -> �Ϲ� ���Ӽ���)

	GT_BUDOKAI_MINOR_MATCH_TELEPORT_INFO_REQ,			// ������ �ڷ���Ʈ ���� (�Ϲ� ���Ӽ��� -> õ�����Ϲ���ȸ ����)
	GT_BUDOKAI_MINOR_MATCH_TELEPORT_INFO_RES,			// ������ �ڷ���Ʈ ���� (õ�����Ϲ���ȸ ���� -> �Ϲ� ���Ӽ���)
	GT_BUDOKAI_PROGRESS_MESSAGE_NFY,					// õ�����Ϲ���ȸ ���� �˸�, ����������,(õ�����Ϲ���ȸ ���� -> �Ϲ� ���Ӽ���)

	GT_BUDOKAI_GM_BUDOKAI_SERVER_ENTER_REQ,				// õ�����Ϲ���ȸ ������ �ڷ���Ʈ ��û
	GT_BUDOKAI_GM_BUDOKAI_SERVER_ENTER_RES,				// õ�����Ϲ���ȸ ������ �ڷ���Ʈ ��û�� �� ����.

	GT_CHAR_MARKING_UPDATE,								// ��� ���Ӽ����� 

	GT_CHAR_SERVER_TELEPORT,							// Ÿ ä�ο��� Player �ʴ�(��ȯ)
	...
	GT_DOJO_SCRAMBLE_REQ,								// ��Ż�� ��û
	GT_DOJO_SCRAMBLE_RESPONSE,							// ��Ż���� ����
	GT_DOJO_SCRAMBLE_STATE_CHANGE,						// ��Ż�� ���º���	
	GT_DOJO_UPDATE_REQ,
	...
	GT_SEND_SERVER_RELAY_DATA,							// �ٸ� ���Ӽ����� data ����
